...
class TestCode(unittest.TestCase):
    ...
    def test_Minus3241(self) -> None:
        assert Solution().myAtoi('-3241') == -3241

    def test_SpaceMinusPlus3241A(self) -> None:
        assert Solution().myAtoi(' -3241a') == -3241

    def test_9223372036854775809(self) -> None:
        assert Solution().myAtoi('9223372036854775809') == 2**31 - 1

    def test_Minus9223372036854775809(self) -> None:
        assert Solution().myAtoi('-9223372036854775809') == -(2**31)

    def test_Nothing(self) -> None:
        assert Solution().myAtoi('nothing') == 0
