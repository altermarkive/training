...
class TestCode(unittest.TestCase):
    def test_example(self):
        ...
        n6 = TreeNode(6, n2, n8)
        self.assertEqual(
            6, Solution().lowestCommonAncestor(n6, n2, n8).val
        )
        self.assertEqual(
            2, Solution().lowestCommonAncestor(n2, n2, n4).val
        )
    ...
    def test_example_1(self):
        ...
        n5 = TreeNode(5, n3, n6)
        self.assertEqual(
            3, Solution().lowestCommonAncestor(n5, n1, n4).val
        )
    ...
    def test_example_2(self):
        ...
        n6 = TreeNode(6, n2, n8)
        self.assertEqual(
            4, Solution().lowestCommonAncestor(n6, n3, n5).val
        )
    ...
    def test_example_3(self):
        ...
        n2 = TreeNode(2, n1, None)
        self.assertEqual(
            2, Solution().lowestCommonAncestor(n2, n2, n1).val
        )
    ...
    def test_example_4(self):
        ...
        self.assertEqual(
            2, Solution().lowestCommonAncestor(n2, n3, n2).val
        )
