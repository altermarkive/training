...
\begin{itemize}
\item (\textbf{shuffle} first or sample for pivot - median as pivot helps; \href{https://leetcode.com/problems/shuffle-an-array/}{leetcode.com/problems/shuffle-an-array/})
\item PICK PIVOT
