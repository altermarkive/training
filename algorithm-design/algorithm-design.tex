...
\flashcard{60}{center}{
HEAPS\linebreak
(Java: PriorityQueue^{\href{https://github.com/altermarkive/training/blob/master/algorithm-design/leetcode/lc155_min_stack/LC155MinStack.cs}{1}}^{\href{https://github.com/altermarkive/training/blob/master/algorithm-design/lc215_kth_largest_element_in_an_array/LC215KthLargestElementInAnArray.cs}{2}})
}
...
\begin{itemize}
\item (\href{https://github.com/altermarkive/training/blob/master/algorithm-design/leetcode/lc384_shuffle_an_array/LC384ShuffleAnArray.cs}{\textbf{shuffle}} first or sample for pivot)
\item PICK PIVOT
