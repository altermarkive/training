...
\begin{itemize}
\item (\href{https://github.com/altermarkive/training/blob/master/algorithm-design/leetcode/lc384_shuffle_an_array/LC384ShuffleAnArray.cs}{\textbf{shuffle}} first or sample for pivot - median as pivot helps)
\item PICK PIVOT
...
\ \\
\(P \neq NP\):\linebreak
\(P \subset NP \), \(NP-COMPLETE \equiv NP \cap NP-HARD\)
}
